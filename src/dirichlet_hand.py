...
class DirichletHand(bch.BCHandler):
    ...
    # @var bc_type the kind of boundary condition ment to be applied by the handler
    ...
    # @var idxs a tuple of indices ((start,noninclusive end),(start,noninclusive end),...)

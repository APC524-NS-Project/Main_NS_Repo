...
class test_finite_difference_stencil_factory:


	def setUp(self):
		self.factory = finite_difference_stencil_factory()
	...
	def test_stencil_matrix(self):
		...
		test_a = self.factory._stencil_matrix(test_1_s)
